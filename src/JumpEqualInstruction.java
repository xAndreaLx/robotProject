...
public class JumpEqualInstruction implements Instruction {
    private String instruction ;
    private String exp1 ;
    private String exp2 ;
    private String lab ; 

    public JumpEqualInstruction(String exp1, String exp2, String lab) {
        this.exp1 = exp1 ;
        this.exp2 = exp2 ;
        this.lab = lab ;
        this.instruction  = "jumpEqual " + this.exp1 + " " + this.exp2 + " " + this.lab ; 
    }
