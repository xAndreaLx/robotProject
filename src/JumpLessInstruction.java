...
public class JumpLessInstruction implements Instruction {
    private String instruction ;
    private String exp1 ;
    private String exp2 ;
    private String lab ; 

    public JumpLessInstruction(String exp1, String exp2, String lab) {
        this.exp1 = exp1 ;
        this.exp2 = exp2 ;
        this.lab = lab ;
        this.instruction  = "jumpLess " + this.exp1 + " " + this.exp2 + " " + this.lab ; 
    }
